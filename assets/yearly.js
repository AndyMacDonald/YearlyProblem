...
var _user$project$Main$crossMap2 = F3(
...
var _user$project$Main$crossMap3 = F4(
	function (f, aList, bList, cList) {
		return A2(
			_elm_lang$core$List$concatMap,
			function (a) {
				return A3(
					_user$project$Main$crossMap2,
					f(a),
					bList,
					cList);
			},
...
var _user$project$Main$insertCandidate = F2(
	function (i, c) {
		return A2(
			_elm_lang$core$Dict$update,
			i,
			function (mc) {
				...
				if (_p0.ctor === 'Nothing') {
					...
					return (_elm_lang$core$Native_Utils.cmp(c.opCount, _p0._0.opCount) < 0) ? _elm_lang$core$Maybe$Just(c) : mc;
				}
			});
	});
var _user$project$Main$collectCandidate = F2(
	function (c, cs) {
		var i = _elm_lang$core$Basics$truncate(c.result);
		return ((_elm_lang$core$Native_Utils.cmp(i, 1) > -1) && ((_elm_lang$core$Native_Utils.cmp(i, 100) < 1) && _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Basics$toFloat(i),
			c.result))) ? A3(_user$project$Main$insertCandidate, i, c, cs) : cs;
	});
var _user$project$Main$countOps = function (t) {
	var _p1 = t;
	if (_p1.ctor === 'Leaf') {
		return 0;
	} else {
		return (1 + _user$project$Main$countOps(_p1._1)) + _user$project$Main$countOps(_p1._2);
	}
};
var _user$project$Main$evalTree = function (t) {
	var _p2 = t;
	if (_p2.ctor === 'Leaf') {
		return _elm_lang$core$Maybe$Just(
			...
			function (left) {
				return A2(
					...
					function (right) {
						...
						switch (_p3.ctor) {
							case 'PLUS':
								return _elm_lang$core$Maybe$Just(left + right);
							case 'MINUS':
								return _elm_lang$core$Maybe$Just(left - right);
							case 'TIMES':
								return _elm_lang$core$Maybe$Just(left * right);
							case 'DIVIDE':
								var x = left / right;
								return _elm_lang$core$Basics$isInfinite(x) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(x);
							default:
								var x = Math.pow(left, right);
								return (_elm_lang$core$Basics$isInfinite(x) || _elm_lang$core$Basics$isNaN(x)) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(x);
						}
					},
					_user$project$Main$evalTree(_p2._2));
			},
			_user$project$Main$evalTree(_p2._1));
	}
};
var _user$project$Main$candidateFromTree = function (t) {
	var opCount = _user$project$Main$countOps(t);
	var _p4 = _user$project$Main$evalTree(t);
	if (_p4.ctor === 'Just') {
		return _elm_lang$core$Maybe$Just(
			{tree: t, opCount: opCount, result: _p4._0});
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Main$timesSym = _elm_lang$core$Char$fromCode(215);
var _user$project$Main$minusSym = _elm_lang$core$Char$fromCode(8722);
var _user$project$Main$formatOp = F4(
										...
										_elm_lang$core$String$fromList(
											{
												...
												_1: {
													ctor: '::',
													_0: _user$project$Main$minusSym,
													_1: {
														ctor: '::',
														_0: _elm_lang$core$Native_Utils.chr(' '),
														_1: {ctor: '[]'}
										...
										_elm_lang$core$String$fromList(
											{
												...
												_1: {
													ctor: '::',
													_0: _user$project$Main$timesSym,
													_1: {
														ctor: '::',
														_0: _elm_lang$core$Native_Utils.chr(' '),
														_1: {ctor: '[]'}
...
var _user$project$Main$operator = function (t) {
	var _p6 = t;
	if (_p6.ctor === 'Node') {
...
var _user$project$Main$commutative = function (o) {
	var _p7 = o;
	switch (_p7.ctor) {
		case 'MINUS':
			return false;
...
var _user$project$Main$precidence = function (o) {
	var _p8 = o;
	switch (_p8.ctor) {
		case 'PLUS':
			return 1;
...
var _user$project$Main$needParens = F2(
	function (parent, child) {
		...
		if (_p9.ctor === 'Nothing') {
			...
			var _p10 = _p9._0;
			return (_elm_lang$core$Native_Utils.eq(
				_user$project$Main$precidence(_p10),
				_user$project$Main$precidence(child)) && (!_user$project$Main$commutative(_p10))) ? true : (_elm_lang$core$Native_Utils.cmp(
				_user$project$Main$precidence(_p10),
				_user$project$Main$precidence(child)) > 0);
		}
	});
var _user$project$Main$formatTree = F2(
	function (parent, t) {
		var _p11 = t;
		if (_p11.ctor === 'Leaf') {
			return {
			...
			var left = A2(
				...
				_p11._1);
			return A4(
				_user$project$Main$formatOp,
				A2(_user$project$Main$needParens, parent, _p12),
				_p12,
				left,
				right);
		}
	});
var _user$project$Main$resultToInt = _elm_lang$core$List$map(
	function (n) {
		var _p13 = n;
		if (_p13.ctor === 'Ok') {
			return _p13._0;
...
var _user$project$Main$noStringErrors = function (_p14) {
	return !A2(
		_elm_lang$core$List$any,
		function (n) {
			var _p15 = n;
...
var _user$project$Main$numsFromString = function (s) {
	return A2(
		_elm_lang$core$List$map,
		_elm_lang$core$String$toInt,
		A2(_elm_lang$core$String$split, ',', s));
};
var _user$project$Main$hasLeadingZeros = function (s) {
	return A2(
		_elm_lang$core$List$any,
		function (x) {
			var _p16 = _elm_lang$core$String$uncons(x);
			if (_p16.ctor === 'Nothing') {
				return false;
			} else {
				return _elm_lang$core$Native_Utils.eq(
					_p16._0._0,
					_elm_lang$core$Native_Utils.chr('0')) && (_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$String$length(_p16._0._1),
					0) > 0);
			}
		},
		A2(_elm_lang$core$String$split, ',', s));
};
var _user$project$Main$groupDigits = function (s) {
	if (_elm_lang$core$Native_Utils.eq(
		...
		if (_p17.ctor === 'Nothing') {
			...
			var _p18 = _p17._0._0;
			var restGroups = _user$project$Main$groupDigits(_p17._0._1);
			var g1 = A2(
				_elm_lang$core$List$map,
				function (s) {
					return A2(_elm_lang$core$String$cons, _p18, s);
				},
				restGroups);
			var g2 = A2(
				_elm_lang$core$List$map,
				...
				restGroups);
			return A2(_elm_lang$core$List$append, g1, g2);
		}
	}
};
var _user$project$Main$swap = F3(
	function (s, l, r) {
		return _elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: A3(_elm_lang$core$String$slice, 0, l, s),
				_1: {
					ctor: '::',
					_0: A3(_elm_lang$core$String$slice, r, r + 1, s),
					_1: {
						ctor: '::',
						_0: A3(_elm_lang$core$String$slice, l + 1, r, s),
						_1: {
							ctor: '::',
							_0: A3(_elm_lang$core$String$slice, l, l + 1, s),
							_1: {
								ctor: '::',
								_0: A3(
...
var _user$project$Main$maxFactBase = F2(
	function (n, i) {
		maxFactBase:
		while (true) {
			if (_elm_lang$core$Native_Utils.eq(i, 1)) {
				return 1;
			} else {
				if (_elm_lang$core$Native_Utils.eq(
					A2(
						_elm_lang$core$Basics_ops['%'],
						n,
						_user$project$Main$factorial(i)),
					0)) {
					return i;
				} else {
					var _v15 = n,
...
var _user$project$Main$permuteIter = F3(
	function (total, count, s) {
		if (_elm_lang$core$Native_Utils.eq(total, count)) {
			return {ctor: '[]'};
		} else {
			var c2 = count + 1;
			var right = A2(
				_user$project$Main$maxFactBase,
				c2,
				_elm_lang$core$String$length(s));
			var left = _elm_lang$core$Native_Utils.eq(
				A2(_elm_lang$core$Basics_ops['%'], right, 2),
				0) ? 0 : (((A2(
				_elm_lang$core$Basics_ops['%'],
				c2,
				_user$project$Main$factorial(right + 1)) / _user$project$Main$factorial(right)) | 0) - 1);
			var s2 = A3(_user$project$Main$swap, s, left, right);
			return {
				ctor: '::',
				_0: s,
				_1: A3(_user$project$Main$permuteIter, total, c2, s2)
			};
		}
	});
var _user$project$Main$permutations = function (s) {
	return A3(
		_user$project$Main$permuteIter,
		_user$project$Main$factorial(
			_elm_lang$core$String$length(s)),
		0,
		s);
};
var _user$project$Main$uniquePermutations = function (s) {
	return {
		ctor: '::',
		_0: s,
		_1: A2(
			_elm_lang$core$List$filter,
			function (a) {
				return !_elm_lang$core$Native_Utils.eq(a, s);
			},
			_elm_lang$core$Set$toList(
				_elm_lang$core$Set$fromList(
					_user$project$Main$permutations(s))))
	};
};
var _user$project$Main$digitGroups = function (s) {
	return A2(
		_elm_lang$core$List$filter,
		function (_p19) {
			return !_user$project$Main$hasLeadingZeros(_p19);
		},
		A2(
			_elm_lang$core$List$concatMap,
			_user$project$Main$groupDigits,
			_user$project$Main$uniquePermutations(s)));
};
var _user$project$Main$columnStyle = function (c) {
	var pad = '20px';
	var cstring = _elm_lang$core$Basics$toString(c);
	return _rtfeldman$elm_css$Html_Styled_Attributes$css(
		{
			ctor: '::',
			_0: A2(_rtfeldman$elm_css$Css$property, '-moz-column-count', cstring),
			_1: {
				ctor: '::',
				_0: A2(_rtfeldman$elm_css$Css$property, '-moz-column-gap', pad),
				_1: {
					ctor: '::',
					_0: A2(_rtfeldman$elm_css$Css$property, '-webkit-column-count', cstring),
					_1: {
						ctor: '::',
						_0: A2(_rtfeldman$elm_css$Css$property, '-webkit-column-gap', pad),
						_1: {
							ctor: '::',
							_0: A2(_rtfeldman$elm_css$Css$property, 'column-count', cstring),
							_1: {
								ctor: '::',
								_0: A2(_rtfeldman$elm_css$Css$property, 'column-gap', pad),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		var _p21 = _p20._0;
		return ((_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(_p21),
			4) < 1) && A2(
			_elm_lang$core$List$all,
			_elm_lang$core$Char$isDigit,
			_elm_lang$core$String$toList(_p21))) ? _elm_lang$core$Native_Utils.update(
			model,
			{content: _p21}) : model;
	});
var _user$project$Main$Candidate = F3(
	function (a, b, c) {
		return {tree: a, opCount: b, result: c};
	});
var _user$project$Main$Model = function (a) {
	return {content: a};
};
var _user$project$Main$model = _user$project$Main$Model('');
var _user$project$Main$EXP = {ctor: 'EXP'};
...
var _user$project$Main$allOps = {
	ctor: '::',
	_0: _user$project$Main$PLUS,
	_1: {
		ctor: '::',
		_0: _user$project$Main$MINUS,
		_1: {
			ctor: '::',
			_0: _user$project$Main$TIMES,
			_1: {
				ctor: '::',
				_0: _user$project$Main$DIVIDE,
				_1: {
					ctor: '::',
					_0: _user$project$Main$EXP,
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$Main$Leaf = function (a) {
	return {ctor: 'Leaf', _0: a};
};
var _user$project$Main$treesFromDigits = function (nums) {
	var _p22 = nums;
	if (_p22.ctor === '[]') {
		return {ctor: '[]'};
	} else {
		if (_p22._1.ctor === '[]') {
			return _elm_lang$core$List$singleton(
				_user$project$Main$Leaf(_p22._0));
		} else {
			return A2(
				_elm_lang$core$List$concatMap,
				_user$project$Main$treesFromSplitDigits(nums),
				A2(
					_elm_lang$core$List$range,
					1,
					_elm_lang$core$List$length(nums) - 1));
		}
	}
};
var _user$project$Main$treesFromSplitDigits = F2(
	function (nums, i) {
		var right = _user$project$Main$treesFromDigits(
			A2(_elm_lang$core$List$drop, i, nums));
		var left = _user$project$Main$treesFromDigits(
			A2(_elm_lang$core$List$take, i, nums));
		return A4(_user$project$Main$crossMap3, _user$project$Main$Node, _user$project$Main$allOps, left, right);
	});
var _user$project$Main$treesFromGroups = function (groups) {
	return A2(
		_elm_lang$core$List$concatMap,
		function (_p23) {
			return _user$project$Main$treesFromDigits(
				_user$project$Main$resultToInt(_p23));
		},
		A2(
			_elm_lang$core$List$filter,
			_user$project$Main$noStringErrors,
			A2(_elm_lang$core$List$map, _user$project$Main$numsFromString, groups)));
};
var _user$project$Main$createTrees = function (_p24) {
	return _user$project$Main$treesFromGroups(
		_user$project$Main$digitGroups(_p24));
};
var _user$project$Main$createCandidates = function (s) {
	return A2(
		_elm_lang$core$List$filterMap,
		_user$project$Main$candidateFromTree,
		_user$project$Main$createTrees(s));
};
var _user$project$Main$collectCandidates = function (s) {
	return A3(
		_elm_lang$core$List$foldl,
		_user$project$Main$collectCandidate,
		_elm_lang$core$Dict$empty,
		_user$project$Main$createCandidates(s));
};
var _user$project$Main$createListItems = function (s) {
	var c = _user$project$Main$collectCandidates(s);
	return A2(
		_elm_lang$core$List$map,
		function (i) {
			return A2(
				...
				{ctor: '[]'},
				function () {
					var _p25 = A2(_elm_lang$core$Dict$get, i, c);
					if (_p25.ctor === 'Nothing') {
						return {ctor: '[]'};
					} else {
						return A2(_user$project$Main$formatTree, _elm_lang$core$Maybe$Nothing, _p25._0.tree);
					}
				}());
		},
		A2(_elm_lang$core$List$range, 1, 100));
};
var _user$project$Main$naiveTree = function (nums) {
	return _user$project$Main$Leaf(0);
};
...
var _user$project$Main$main = _elm_lang$html$Html$beginnerProgram(
	{
		model: _user$project$Main$model,
		view: function (_p26) {
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				_user$project$Main$view(_p26));
		},
